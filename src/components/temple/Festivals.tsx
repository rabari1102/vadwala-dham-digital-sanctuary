  ...
  return (
    <section id="festivals" className="py-16 md:py-24 bg-gradient-to-b from-muted/30 to-background">
      <div className="container mx-auto px-4">
          ...
          {festivals.map((f, i) => {
            ...
            return (
              <div
                key={i}
                ref={cardRef}
                className="fade-in-section hover-lift rounded-xl bg-gradient-saffron p-6 text-center shadow-md"
        ...
        {/* Banner */}
        <div className="max-w-4xl mx-auto mb-10 rounded-xl bg-temple-maroon/10 border border-temple-maroon/20 p-6 text-center">
          <p className="text-foreground font-heading text-base md:text-lg leading-relaxed">
            During major festivals, <strong className="text-temple-saffron">2–3 LAKH devotees</strong> visit.
            The temple arranges food and accommodation for all.
          </p>
        </div>

        {/* Upcoming */}
        <div className="max-w-2xl mx-auto">
          <h3 className="font-heading font-bold text-xl text-foreground text-center mb-4">
            📅 Upcoming Events
          </h3>
          <div className="space-y-3">
            {upcoming.map((u, i) => (
              <div
                key={i}
                className="flex items-center gap-4 rounded-lg border border-temple-gold/20 bg-card px-5 py-3 shadow-sm"
              >
                ...
                <span className="ml-auto inline-block rounded-full bg-temple-gold/20 text-temple-saffron text-xs font-semibold px-3 py-1">
                  Upcoming
                </span>
              </div>
            ))}
