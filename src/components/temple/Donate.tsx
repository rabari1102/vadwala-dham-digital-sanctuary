            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              ...
              <div className="flex-1 text-center md:text-left">
                <h3 className="font-heading font-bold text-xl text-foreground mb-3">
                  Shri Vadwala Mandir Dudhrejdham
                </h3>
                <p className="text-sm text-muted-foreground mb-4">
                  FCRA & 80G eligible donations
                </p>
                ...
                <div className="flex flex-wrap gap-2 mb-6 justify-center md:justify-start">
                  {purposes.map((p) => (
                    <span
                      key={p}
                      className="rounded-full border border-temple-gold/30 bg-temple-gold/10 px-3 py-1 text-xs font-medium text-temple-saffron cursor-pointer hover:bg-temple-gold/30 transition-colors"
                    >
                      {p}
                    </span>
                  ))}
                ...
                <a
                  href="#"
                  className="inline-flex items-center gap-2 rounded-full bg-temple-gold px-8 py-3 text-base font-bold text-temple-dark hover:shadow-lg transition-all"
                >
                  🙏 Donate Now
                </a>

                <p className="text-xs text-muted-foreground mt-4">
                  For bank transfer details, please contact: <strong>96879 21008</strong>
                </p>
              </div>
            </div>
          </div>
